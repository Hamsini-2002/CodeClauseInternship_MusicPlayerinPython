...
doc_path = r'C:\Users\HP\Downloads\Music Player\Music Player\images'
...
img = PhotoImage(file = doc_path+"\\"+"music.gif")
next_ = PhotoImage(file = doc_path+"\\"+"next.gif")
prev = PhotoImage(file = doc_path+"\\"+"previous.gif")
play = PhotoImage(file = doc_path+"\\"+"play.gif")
pause = PhotoImage(file = doc_path+"\\"+"pause.gif")
